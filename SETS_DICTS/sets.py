...
# set0.update(list1)
# print (set0)
#  remove(Hata veriyor), discard(Hata vermiyor) = silme 

# set1.discard("Begonya")
# set1.remove("Begonya")
# set1.clear()
...
# yeniSet = set0.intersection(set1)
# yeniSet =set0 & set1

# print(yeniSet)

# farkSeti = set1.difference(set2)
# farkSeti2 = set1 - set2 
# print(farkSeti)

# simetrikFark = set1.symmetric_difference(set2)

# simetrikFark2 = set1 ^ set2 
